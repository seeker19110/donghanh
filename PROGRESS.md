...
- 🟡 **[2026-09-22 — audit UI/UX sâu, `docs/audit/2026-09-22-danh-gia-sau-ui-ux.md` +
  ...
  **Kiểm lại 2026-09-22 (audit lần 2, `docs/audit/2026-09-22-danh-gia-toan-dien-ui-ux-lan-2.md`,
  ...
  2026-09-24 (`docs/changelog/0433-*.md`)**: không phải nhiễu đo — sàn comeback mobile của
  `HomeAiBriefingCard` thiếu 46px (2 nút icon làm chữ xuống 3 dòng); CLS dưới tải 0,056–0,090 →
  0,022–0,026, 30/30 xanh, ngưỡng 0,1 giữ nguyên.**
