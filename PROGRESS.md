...
| S06-1 | Hợp đồng `TodayPlan`/`ResumePoint` + resolver "Hôm nay" (0 đổi giao diện)               | ✅ **ĐÃ THI HÀNH** (`docs/changelog/0335-*.md`; đặc tả `docs/specs/2026-09-15-learning-ux-s06-hom-nay-hoc-tiep.md` §9 mục 1). Tiếp theo: S06-2 thẻ "Hôm nay" ở Trang chủ, S06-3 trang môn dùng chung resolver                                                                                                    |
