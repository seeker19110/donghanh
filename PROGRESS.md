...
| S08-1 | Khung phiên học `LearningSession` + hook resume cùng thiết bị (0 đổi giao diện)         | ✅ **ĐÃ THI HÀNH** (`docs/changelog/0331-*.md`; đặc tả `docs/specs/2026-09-15-learning-ux-s08-khung-phien-resume.md` §9 mục 1). Tiếp theo: S08-2 (bài Lập trình). S08-3 phần STEM đã thi hành (`docs/changelog/0347-*.md`, PR #962); phần tab học CEFR (AC-18/AC-19) còn lại, làm PR riêng sau khi S07-3 (#960) đã vào `main` |
