...
| S08-2 | Nháp code + bước đang học của bài Lập trình sống qua reload (cùng thiết bị)             | ✅ **ĐÃ THI HÀNH** (`docs/changelog/0343-*.md`; đặc tả §9 mục 2, PR [#961](https://github.com/seeker19110/donghanh/pull/961)). Còn lại của S08: S08-3 phần STEM đã thi hành (`docs/changelog/0347-*.md`, PR [#962](https://github.com/seeker19110/donghanh/pull/962)); phần tab học CEFR (AC-18/AC-19) làm PR riêng sau khi S07-3 (#960) đã vào `main` |
