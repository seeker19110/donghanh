...
| S08-2 | Nháp code + bước đang học của bài Lập trình sống qua reload (cùng thiết bị)             | ✅ **ĐÃ THI HÀNH** (`docs/changelog/0343-*.md`; đặc tả §9 mục 2). Còn lại của S08: S08-3 (STEM + tab học CEFR)                                                                                                                                                                                                                                       |
