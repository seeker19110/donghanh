...
| Q2  | S07 có phải đợi 02–04 merge không (goal ghi "Dependency: 04")?                                                                                                | **S07-1 và S07-2 KHÔNG đợi** (Lập trình/STEM không chạm entry English, không chạm default `'english'`). **S07-3 đợi slice 03** vì 03 có thể dời `/lo-trinh-hoc`. | Tránh nghẽn: 02 đang chờ Q1–Q3, 03/04 chưa READY. Mục lục Lập trình/STEM là giá trị người học thấy ngay.                                                                        |
