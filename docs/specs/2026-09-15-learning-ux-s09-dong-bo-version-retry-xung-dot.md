...
| Q5  | S09-3 (`ConflictRecord`) chỉ có nghĩa khi S08 đẩy nháp lên server. S08 hiện chốt "cùng thiết bị". Làm S09-3 ngay hay chờ S08 mở rộng cross-device? | **S09-1 tạo sẵn bảng + contract; S09-3 CHỜ S08 có endpoint nháp** (hoặc gộp vào slice S08-2 nếu S08 quyết đẩy nháp lên).                                                                     | Không dựng UI hỏi xung đột cho tài liệu chưa tồn tại trên server (vi phạm "không triển khai dở dang"). Tiến độ tổng hiện có KHÔNG BAO GIỜ sinh ConflictRecord (AC-18 test canh) nên S09-1/2 độc lập.                                                                  |
