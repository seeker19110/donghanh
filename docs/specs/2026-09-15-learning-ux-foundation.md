...
| Bất biến đọc     | `apps/dhcb/src/lib/guestProgress.ts`, `apps/dhcb/src/lib/dailyLearningPlan.ts`, `apps/server/src/api/core/progress.ts`           | Guest merge, evidence và completion authority                                           |
...
| Completion/quyền do server, không do AI/click      | `apps/server/src/api/core/progress.test.ts`, `apps/dhcb/src/lib/dailyLearningPlan.test.ts`         |
