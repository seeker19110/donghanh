...
| S08-3 | Resume STEM (phần tab học CEFR hoãn) | S08-1 | [S08](../specs/2026-09-15-learning-ux-s08-khung-phien-resume.md) (Approved for implementation) | PR nháp | E2E `learning-session-resume-stem` 3/3 · a11y 455/455 · `StemLesson.test.tsx` 14 ca · ảnh 1440/390/320 trước-sau | REVIEW | [0347](../changelog/0347-2026-09-16-s08-3-resume-tu-kiem-tra-stem.md) — AC-18/AC-19 (tab học CEFR) TÁCH sang PR sau: nhánh S07-3 đang mở đổi 207 dòng đúng vùng `tab`/màn con của `CefrLevelPage.tsx` |
