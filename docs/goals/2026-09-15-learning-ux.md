...
| S09-2 | Outbox client: retry, gộp, hai tab, hết auth | S09-1 | [S09](../specs/2026-09-15-learning-ux-s09-dong-bo-version-retry-xung-dot.md) §9 mục 2 (AC-8…AC-17) | Chưa tạo | [#PR_NUMBER](https://github.com/seeker19110/donghanh/pull/PR_NUMBER) | REVIEW | [0353](../changelog/0353-2026-09-16-s09-2-outbox-dong-bo-tien-do.md) — `syncOutbox.ts`, xoá `offlineStore.ts`, sửa F1/F4/F5 |
...
| S12-3 | Tiến độ theo môn chỉ từ evidence trên `/tien-do` | S12-2 + S07-1 | [S12](../specs/2026-09-15-learning-ux-s12-on-lai-so-loi-tien-do.md) §9 mục 3 (Approved for implementation) | Chưa tạo | — | READY | Chốt §7 theo mặc định 2026-09-15 |
