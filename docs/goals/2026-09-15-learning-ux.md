...
Các mã S giữ liên kết kế hoạch cũ; thứ tự mới ưu tiên 0S → 01–04 → S07 trước S05/S06. S05–S13 đã có đặc tả riêng (2026-09-15, changelog 0326), đều In review — chưa READY cho tới khi chủ dự án chốt §7 từng file; S04 đi cùng từng slice. Làm tuần tự; mỗi PR giao một subagent và agent chính review diff/gate.
...
| S07   | Mục lục môn/khóa độc lập shellbar          | S07-1/2: không đợi 02–04; S07-3: 03 | [S07](../specs/2026-09-15-goc-hoc-tap-07-muc-luc-mon-khoa.md) (In review)                    | Chưa tạo | —                                                        | SPEC    | Đặc tả + adapter spec 3 môn, chờ Q1–Q5                                       |
