...
| S06-3 | Trang môn dùng chung resolver "học tiếp" | S06-2 | [S06](../specs/2026-09-15-learning-ux-s06-hom-nay-hoc-tiep.md) (Approved for implementation) | [#963](https://github.com/seeker19110/donghanh/pull/963) | E2E 43/43 (thêm 2 ca đa môn) · a11y 472/472 · coverage 94,28/90,18/94,79/94,79 · ảnh 1440/390/320 trước-sau trùng kích thước | REVIEW | [0348](../changelog/0348-2026-09-16-s06-3-trang-mon-dung-chung-resolver.md) — `pickNextLesson` không còn trong `pages/`; `CefrLevelPage:621` giữ `findNextStep` (cách dùng khác, có lý do đo được); sửa `dongNguon` nuốt tên môn thứ hai |
