...
| S09-1 | Version đơn điệu + idempotency (server)      | — (merge độc lập)           | [S09](../specs/2026-09-15-learning-ux-s09-dong-bo-version-retry-xung-dot.md) §9 mục 1 (AC-1…AC-7)              | Chưa tạo | #TBD                                                     | REVIEW  | [0334](../changelog/0334-2026-09-15-s09-1-version-idempotency-dong-bo.md) — migration 0082, 0 đổi giao diện                                                                   |
