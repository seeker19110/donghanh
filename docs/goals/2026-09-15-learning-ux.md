...
| S12-1   | Hàng đợi ôn xuyên môn + thẻ SRS STEM + hub   | S07-1                       | [S12](../specs/2026-09-15-learning-ux-s12-on-lai-so-loi-tien-do.md) §9 mục 1 (Approved for implementation)     | Chưa tạo      | PR S12-1 (đang mở)                                       | IN REVIEW                  | [0341](../changelog/0341-2026-09-16-s12-1-hang-doi-on-xuyen-mon.md) — golden snapshot SRS chụp ở commit đầu; nhóm STEM chưa có thẻ tới khi S11-3 gọi `addStemLessonCardsToSrs` |
