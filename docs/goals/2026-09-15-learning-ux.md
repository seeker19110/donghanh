...
| S05   | Bắt đầu theo ý định, thống nhất hub          | S06 + spec                  | [S05](../specs/2026-09-15-learning-ux-s05-bat-dau-theo-y-dinh.md) (Approved for implementation)                | S05-1 PR nháp | changelog `0334` · migration `0083` · chunk 5,38 kB gzip | S05-1 REVIEW · S05-2 READY | Chốt §7 theo mặc định 2026-09-15; migration lấy số `0082` theo thứ tự merge thật (`0081` đã bị S11 chiếm)                                                                     |
