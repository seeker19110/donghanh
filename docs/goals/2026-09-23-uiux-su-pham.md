...
| M2/S06 | Gate AAA phản ánh đúng chữ thực và 7:1 (F5)               | S00           | Follow-up #1139; **S06b Approved 24/09**      | #1122    | PARTIAL — S06b source kế tiếp | Phủ AAA `/luyen-tap` + `/goc-hoc-tap/english`, sửa nền gradient; ma trận rộng còn mở              |
...
| M3/S09 | Điều hướng trong bài dài; kết quả gọn, sửa sai thuận tiện | M1, M2        | Review #1135; B2/B3 #1136; **Approved 24/09** | —        | APPROVED — source chưa        | B1 đóng mức kỹ thuật; S09a→S09b→S09c/d; ảnh/AT thật vẫn WAITING                                   |
