...
| M2/S1a | `mathforcode-s1`: số, logic, modulo, Big-O có bài thật       | M1         | `2026-09-16-mathforcode-s1-bai-hoc-that.md`   | —     | #943 | WAITING | Spec chờ CI/merge         |
...
- Goal gap hiện tại: 14/27 chặng chuyên sâu của `principal-ai` chưa có unit thật.
- Blocker/câu hỏi mở: không; production deploy vẫn ngoài phạm vi được cấp.
- Next best slice: M2/S1a — thi hành bài học thật cho `mathforcode-s1` sau khi spec merge.
