...
| 2 Design        | FEATURE_SPEC · design tokens `index.css` · components hiện có | DESIGN_SPEC                      | phiên chính hoặc subagent `standard-worker` với brief = FEATURE_SPEC; skill `ui-ux`                              | Sol                                    |
