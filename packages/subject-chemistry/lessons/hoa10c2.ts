...
export const HOA10_C2_LESSONS: ChemLesson[] = [
  {
    ...
    animation: {
      ...
      description:
        'Cấu hình electron của sulfur hiện ra từng lớp một: 1s² rồi 2s²2p⁶ rồi 3s²3p⁴. Đếm số lớp được 3 lớp — đó chính là số chu kì, nên sulfur nằm ở hàng thứ 3. Đếm số electron ở lớp ngoài cùng được 2 + 4 = 6 — đó chính là số thứ tự nhóm A, nên sulfur nằm ở cột VIA. Ô sáng trong lưới trượt từ góc trên bên trái xuống đúng giao điểm hàng 3 và cột VIA rồi dừng lại. Điều cần thấy: vị trí trong bảng không phải học thuộc, nó đọc thẳng ra từ cấu hình electron.',
      viewBoxWidth: 440,
      viewBoxHeight: 230,
      durationMs: 7000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Viết cấu hình electron của sulfur: 1s²2s²2p⁶3s²3p⁴.',
        },
        {
          atMs: 2600,
          text: 'Số lớp electron = số thứ tự chu kì → 3 lớp, chu kì 3.',
        },
        {
          atMs: 3600,
          text: 'Số electron lớp ngoài cùng = số thứ tự nhóm A → 6, nhóm VIA.',
        },
        {
          atMs: 5600,
          text: 'Giao của hàng 3 và cột VIA chính là ô của sulfur.',
        },
      ],
    },
    track: 'core',
