...
export const HOA12_C6_LESSONS: ChemLesson[] = [
  ...
  },
  {
    ...
    animation: {
      ...
      description:
        'Hai khối tinh thể cùng chịu một lực gõ từ trên xuống. Bên trái là kim loại: các ion dương cùng dấu nhưng nằm chìm trong biển electron chung. Khi lớp trên trượt sang, biển electron trượt theo và vẫn nối lớp trên với lớp dưới, nên khối chỉ biến dạng chứ không tách ra — kim loại dát mỏng, kéo sợi được. Bên phải là tinh thể ion như NaCl: các ion dương và ion âm xếp xen kẽ đều đặn. Khi lớp trên trượt đúng một ô, các ion cùng dấu đột nhiên đối diện nhau, lực hút chuyển thành lực đẩy và khối tinh thể nứt đúng theo mặt phẳng đó. Cùng một cú gõ mà một bên dẹp xuống, một bên vỡ vụn — khác biệt nằm ở chỗ liên kết có bị định hướng hay không.',
      viewBoxWidth: 470,
      viewBoxHeight: 240,
      durationMs: 8000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 352,
          y: 162,
          text: 'Tinh thể ion: ion cùng dấu gặp nhau',
          size: 11,
          anchor: 'middle',
          fill: 'neutral',
          opacity: 0,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Cùng một cú gõ tác dụng lên khối kim loại và khối tinh thể ion.',
        },
        {
          atMs: 4000,
          text: 'Kim loại: lớp trên trượt, biển electron trượt theo và vẫn giữ liên kết.',
        },
        {
          atMs: 4400,
          text: 'Tinh thể ion: lớp trên trượt một ô, ion cùng dấu đối diện nhau.',
        },
        {
          atMs: 5200,
          text: 'Lực đẩy làm tinh thể nứt — kim loại dẻo, muối giòn.',
        },
      ],
    },
    track: 'core',
    ...
    animation: {
      ...
      shapes: [
        ...
        },
        {
          ...
          x: 283,
          y: 130,
          text: 'CO, C hoặc H₂ khử oxide, t° cao',
          size: 10,
          anchor: 'middle',
          fill: 'muted',
          opacity: 0,
  ...
  },
  {
    ...
    animation: {
      ...
      description:
        'Một thanh sắt gắn liền với một thanh đồng, cả hai cùng nhúng trong màng nước có hoà tan ' +
        'chất điện li (nước mưa, không khí ẩm). Ba điều kiện của ăn mòn điện hoá đủ cả: hai điện ' +
        'cực khác chất, tiếp xúc nhau, cùng nằm trong dung dịch điện li. Kết quả là hình thành ' +
        'một pin điện hoá tí hon ngay trên bề mặt vật: sắt hoạt động mạnh hơn nên đóng vai trò ' +
        'anode, bị oxi hoá Fe → Fe²⁺ + 2e và tan dần vào dung dịch (chỗ này gỉ, lõm đi). ' +
        'Electron chạy qua chỗ tiếp xúc sang thanh đồng — đóng vai trò cathode — và ở đó oxygen ' +
        'hoà tan nhận electron: O₂ + 2H₂O + 4e → 4OH⁻. Vì electron được "kéo đi" liên tục nên ' +
        'sắt tan nhanh hơn hẳn so với khi đứng một mình. Đảo lại nguyên lí này chính là cách bảo ' +
        'vệ vỏ tàu: gắn khối kẽm để kẽm làm anode và bị ăn mòn thay cho sắt.',
      viewBoxWidth: 440,
      viewBoxHeight: 220,
      durationMs: 6000,
      loop: true,
      shapes: [
        ...
        { kind: 'rect', id: 'cu', x: 220, y: 70, w: 130, h: 46, rx: 3, fill: 'accent' },
        {
          kind: 'label',
          id: 'fe-t',
          x: 155,
        ...
        },
        {
          ...
          keyframes: [
            ...
            { atMs: 800, opacity: 1, dy: 0 },
            { atMs: 3000, opacity: 1, dy: 55 },
            { atMs: 6000, opacity: 1, dy: 55 },
          ],
        },
        {
          kind: 'circle',
          ...
          opacity: 0,
          keyframes: [
            { atMs: 1800, opacity: 0, dy: 0 },
            { atMs: 2400, opacity: 1, dy: 0 },
            { atMs: 4600, opacity: 1, dy: 48 },
            { atMs: 6000, opacity: 1, dy: 48 },
          ],
        },
        {
          kind: 'circle',
          ...
          keyframes: [
            { atMs: 0, dx: 0 },
            { atMs: 1800, dx: 90 },
            { atMs: 2000, dx: 90, opacity: 0 },
            { atMs: 6000, dx: 90, opacity: 0 },
          ],
        },
        {
          kind: 'circle',
          ...
          opacity: 0,
          keyframes: [
            { atMs: 1200, dx: 0, opacity: 1 },
            { atMs: 3000, dx: 90, opacity: 1 },
            { atMs: 3200, dx: 90, opacity: 0 },
            { atMs: 6000, dx: 90, opacity: 0 },
          ],
        },
        {
        ...
        },
        {
          ...
          keyframes: [
            { atMs: 0, dy: 0 },
            { atMs: 2600, dy: -28 },
            { atMs: 3000, dy: -28, opacity: 0 },
            { atMs: 6000, dy: -28, opacity: 0 },
          ],
        },
      ],
      captions: [
        {
          atMs: 0,
          text: 'Đủ 3 điều kiện: hai kim loại khác nhau, tiếp xúc, cùng trong dung dịch điện li.',
        },
        { atMs: 1200, text: 'Sắt (mạnh hơn) làm anode: tan ra thành Fe²⁺ và nhả electron.' },
        {
          atMs: 2600,
          text: 'Electron sang đồng, ở đó oxygen hoà tan nhận electron — sắt tan càng nhanh.',
        },
      ],
    },
    track: 'core',
