    ...
    animation: {
      ...
      shapes: [
        ...
        },
        {
          ...
          stroke: 'primary',
          strokeWidth: 3,
          // Renderer chỉ xoay quanh TÂM hình (trung điểm đoạn), nên "quay quanh gốc O" phải mô phỏng
          // bằng rotate quanh trung điểm + tịnh tiến trung điểm chạy trên đường tròn bán kính r/2.
          // 17 mốc cách 22,5° — soi ảnh theo thời gian 2026-09-22 thấy bản cũ (rotate đơn thuần)
          // thành thanh xoay lơ lửng giữa vòng tròn.
          keyframes: [
            { atMs: 0, rotate: -0, dx: 0, dy: -0 },
            { atMs: 500, rotate: -22.5, dx: -2.28, dy: -11.48 },
            { atMs: 1000, rotate: -45, dx: -8.79, dy: -21.21 },
            { atMs: 1500, rotate: -67.5, dx: -18.52, dy: -27.72 },
            { atMs: 2000, rotate: -90, dx: -30, dy: -30 },
            { atMs: 2500, rotate: -112.5, dx: -41.48, dy: -27.72 },
            { atMs: 3000, rotate: -135, dx: -51.21, dy: -21.21 },
            { atMs: 3500, rotate: -157.5, dx: -57.72, dy: -11.48 },
            { atMs: 4000, rotate: -180, dx: -60, dy: -0 },
            { atMs: 4500, rotate: -202.5, dx: -57.72, dy: 11.48 },
            { atMs: 5000, rotate: -225, dx: -51.21, dy: 21.21 },
            { atMs: 5500, rotate: -247.5, dx: -41.48, dy: 27.72 },
            { atMs: 6000, rotate: -270, dx: -30, dy: 30 },
            { atMs: 6500, rotate: -292.5, dx: -18.52, dy: 27.72 },
            { atMs: 7000, rotate: -315, dx: -8.79, dy: 21.21 },
            { atMs: 7500, rotate: -337.5, dx: -2.28, dy: 11.48 },
            { atMs: 8000, rotate: -360, dx: 0, dy: 0 },
          ],
        },
        {
          kind: 'circle',
          ...
          keyframes: [
            { atMs: 0, dx: 0, dy: -0 },
            { atMs: 500, dx: -4.57, dy: -22.96 },
            { atMs: 1000, dx: -17.57, dy: -42.43 },
            { atMs: 1500, dx: -37.04, dy: -55.43 },
            { atMs: 2000, dx: -60, dy: -60 },
            { atMs: 2500, dx: -82.96, dy: -55.43 },
            { atMs: 3000, dx: -102.43, dy: -42.43 },
            { atMs: 3500, dx: -115.43, dy: -22.96 },
            { atMs: 4000, dx: -120, dy: -0 },
            { atMs: 4500, dx: -115.43, dy: 22.96 },
            { atMs: 5000, dx: -102.43, dy: 42.43 },
            { atMs: 5500, dx: -82.96, dy: 55.43 },
            { atMs: 6000, dx: -60, dy: 60 },
            { atMs: 6500, dx: -37.04, dy: 55.43 },
            { atMs: 7000, dx: -17.57, dy: 42.43 },
            { atMs: 7500, dx: -4.57, dy: 22.96 },
            { atMs: 8000, dx: 0, dy: 0 },
          ],
        },
        {
          ...
          keyframes: [
            { atMs: 0, dx: 0, dy: -0 },
            { atMs: 500, dx: 15, dy: -22.96 },
            { atMs: 1000, dx: 30, dy: -42.43 },
            { atMs: 1500, dx: 45, dy: -55.43 },
            { atMs: 2000, dx: 60, dy: -60 },
            { atMs: 2500, dx: 75, dy: -55.43 },
            { atMs: 3000, dx: 90, dy: -42.43 },
            { atMs: 3500, dx: 105, dy: -22.96 },
            { atMs: 4000, dx: 120, dy: -0 },
            { atMs: 4500, dx: 135, dy: 22.96 },
            { atMs: 5000, dx: 150, dy: 42.43 },
            { atMs: 5500, dx: 165, dy: 55.43 },
            { atMs: 6000, dx: 180, dy: 60 },
            { atMs: 6500, dx: 195, dy: 55.43 },
            { atMs: 7000, dx: 210, dy: 42.43 },
            { atMs: 7500, dx: 225, dy: 22.96 },
            { atMs: 8000, dx: 240, dy: 0 },
          ],
        },
        {
          kind: 'polyline',
