...
xemdiff v1`,
    ...
    predict: {
      ...
      choices: [
        'Vẫn tạo bản nháp bình thường (mô phỏng không bắt buộc mục này)',
        'Từ chối vì thiếu mục "khong lam"',
        'Tự động thêm mục "khong lam" hộ',
        'Hỏi lại người dùng có muốn thêm mục "khong lam" không',
      ],
      answerIndex: 0,
      explain:
...
xemdiff v1`,
      ...
      choices: [
        'Có — mô tả đã nhắc rõ ca "% giam lon hon 100"',
        'Không — mô tả quá chung chung',
        'Không thể biết nếu chưa chạy kehoach',
        'Có nhưng không liên quan mô tả',
      ],
      answerIndex: 0,
      explain:
...
lichsu`,
    ...
    predict: {
      ...
      choices: [
        ...
        'Chỉ in mốc gần nhất',
        'Sắp xếp theo bảng chữ cái tên mốc',
      ],
      answerIndex: 0,
      explain:
...
nhan v1`,
      ...
      choices: [
        'TRƯỚC xemdiff — hiểu tổng quan rồi mới đọc diff chi tiết',
        'SAU nhan — hiểu sau khi đã vào dự án cũng được',
        'Không cần nếu đã đọc diff',
        'Thay thế hoàn toàn cho xemdiff',
      ],
      answerIndex: 0,
      explain:
...
kiemtra`,
    ...
    predict: {
      ...
      choices: [
        'Chỉ kiểm v1 (đã nhận) — v2 chưa tính vào dự án',
        'Kiểm cả v1 và v2',
        'Báo lỗi vì v2 chưa nhận',
        'Tự động nhận v2 trước khi kiểm',
      ],
      answerIndex: 0,
      explain:
