...
export const LESSON_INDEX: readonly LessonSummary[] = [
  ...
  {
    id: 'p6-u182-l1', unitId: 'p6-u182',
    title: 'MÔ PHỎNG trust boundary — thiếu bằng chứng là unknown-risk', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u182-l2', unitId: 'p6-u182',
    title: 'MÔ PHỎNG least privilege — actor, resource, action ngoài policy thì deny', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u183-l1', unitId: 'p6-u183',
    title: 'MÔ PHỎNG crypto purpose — password hash, encryption, signature', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u183-l2', unitId: 'p6-u183',
    title: 'MÔ PHỎNG crypto lifecycle — salt và rotation là contract bắt buộc', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u184-l1', unitId: 'p6-u184', title: 'Kiểm query và encode theo allowlist', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u184-l2', unitId: 'p6-u184', title: 'Ủy quyền object phía server — foreign ID phải deny', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u185-l1', unitId: 'p6-u185',
    title: 'MÔ PHỎNG vòng đời session: rotation, expiry và revoked', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u185-l2', unitId: 'p6-u185',
    title: 'MÔ PHỎNG recovery rate limit và deny theo policy', language: 'python', srsCardCount: 2,
  },
  {
    id: 'p6-u166-l1',
    unitId: 'p6-u166',
