...
export const LESSON_INDEX: readonly LessonSummary[] = [
  ...
  },
  {
    id: 'p6-u234-l1',
    unitId: 'p6-u234',
    title: 'MÔ PHỎNG bước nhảy truy cập và tỉ lệ trượt cache',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u234-l2',
    unitId: 'p6-u234',
    title: 'MÔ PHỎNG false sharing — hai biến khác nhau, một dòng cache',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u235-l1',
    unitId: 'p6-u235',
    title: 'MÔ PHỎNG vi chuẩn không tự lừa mình — nhiễu và số mẫu',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u235-l2',
    unitId: 'p6-u235',
    title: 'MÔ PHỎNG định luật Amdahl — chỗ nào đáng tối ưu',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u236-l1',
    unitId: 'p6-u236',
    title: 'MÔ PHỎNG bộ nhớ ảo — khi tập làm việc không vừa bộ nhớ vật lý',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u236-l2',
    unitId: 'p6-u236',
    title: 'MÔ PHỎNG cách ly tiến trình và chi phí syscall',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u237-l1',
    unitId: 'p6-u237',
    title: 'MÔ PHỎNG hàng rào bộ nhớ tại điểm công bố',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u237-l2',
    unitId: 'p6-u237',
    title: 'MÔ PHỎNG hàng đợi lock-free — rỗng và tràn là trạng thái, không phải tai nạn',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u238-l1',
    unitId: 'p6-u238',
    title: 'MÔ PHỎNG phân tích ngữ nghĩa — biến dùng trước khi khai báo',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u238-l2',
    unitId: 'p6-u238',
    title: 'MÔ PHỎNG hệ thống kiểu — phép toán không hợp kiểu',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u239-l1',
    unitId: 'p6-u239',
    title: 'MÔ PHỎNG mark-sweep — đến được từ gốc thì không được thu gom',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u239-l2',
    unitId: 'p6-u239',
    title: 'MÔ PHỎNG máy ảo ngăn xếp — thiếu toán hạng và thiếu khung',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u240-l1',
    unitId: 'p6-u240',
    title: 'MÔ PHỎNG bảng trang — hai tiến trình, hai không gian địa chỉ',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u240-l2',
    unitId: 'p6-u240',
    title: 'MÔ PHỎNG lập lịch vòng tròn và chuyển ngữ cảnh đủ trường',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u241-l1',
    unitId: 'p6-u241',
    title: 'MÔ PHỎNG tràn bộ đệm và các lớp phòng thủ',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u241-l2',
    unitId: 'p6-u241',
    title: 'MÔ PHỎNG fuzzing theo độ phủ — khi nào nên đổi chiến lược',
    language: 'python',
    srsCardCount: 2,
  },
  {
  ...
  },
  {
    id: 'p6-u282-l1',
    unitId: 'p6-u282',
    title: 'MÔ PHỎNG đọc theo luồng (stream) và ảo hoá danh sách triệu dòng',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u282-l2',
    unitId: 'p6-u282',
    title: 'MÔ PHỎNG tìm kiếm toàn văn: có chỉ mục trước, quét toàn bộ sau',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u283-l1',
    unitId: 'p6-u283',
    title: 'MÔ PHỎNG ngân sách startup và RAM lúc nghỉ',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u283-l2',
    unitId: 'p6-u283',
    title: 'MÔ PHỎNG đo cho ra số đáng tin: trung vị, đủ mẫu, máy cấu hình thấp',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u284-l1',
    unitId: 'p6-u284',
    title: 'MÔ PHỎNG sandbox trước, api version sau, plugin crash không giết host',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u284-l2',
    unitId: 'p6-u284',
    title: 'MÔ PHỎNG quyền của plugin: xin gì được nấy, không hơn',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u285-l1',
    unitId: 'p6-u285',
    title: 'MÔ PHỎNG ma trận platform và hai luồng phải test: cài đặt, cập nhật',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u285-l2',
    unitId: 'p6-u285',
    title: 'MÔ PHỎNG test giao diện ổn định: chờ theo điều kiện, không chờ theo giây',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u286-l1',
    unitId: 'p6-u286',
    title: 'MÔ PHỎNG license, kích hoạt offline và phát hiện clock rollback',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u286-l2',
    unitId: 'p6-u286',
    title: 'MÔ PHỎNG bản dùng thử và hoàn tiền: hết hạn không đồng nghĩa mất dữ liệu',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u287-l1',
    unitId: 'p6-u287',
    title: 'MÔ PHỎNG channel, rolloutPercent và rollback khi health-check đỏ',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u287-l2',
    unitId: 'p6-u287',
    title: 'MÔ PHỎNG di trú dữ liệu qua nhiều phiên bản: tiến được, lùi được',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u288-l1',
    unitId: 'p6-u288',
    title: 'MÔ PHỎNG signature, admin rights và phụ thuộc có lỗ hổng',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u288-l2',
    unitId: 'p6-u288',
    title: 'MÔ PHỎNG dữ liệu ở lại trên máy: gửi ra ngoài phải có lý do và sự cho phép',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u289-l1',
    unitId: 'p6-u289',
    title: 'MÔ PHỎNG triage báo lỗi: che nội dung người dùng, đòi bundle, đếm affectedUserCount',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u289-l2',
    unitId: 'p6-u289',
    title: 'MÔ PHỎNG lộ trình dựa trên yêu cầu thật, không dựa trên người nói to nhất',
    language: 'python',
    srsCardCount: 2,
  },
  {
  ...
  },
  {
    id: 'p6-u179-l1',
    unitId: 'p6-u179',
    title: 'MÔ PHỎNG quality gate song song và artifact bất biến (immutable)',
    language: 'python',
    srsCardCount: 2,
  },
  {
    id: 'p6-u179-l2',
    unitId: 'p6-u179',
    title: 'MÔ PHỎNG ngưỡng sức khoẻ canary và rollback fail closed',
    language: 'python',
    srsCardCount: 2,
  },
  {
...
export const UNIT_LOADERS: Readonly<Record<string, () => Promise<ProgrammingLesson[]>>> = {
  ...
  'p6-u242': () => import('./lessons/p6u242.js').then((m) => m.P6U242_LESSONS),
  'p6-u243': () => import('./lessons/p6u243.js').then((m) => m.P6U243_LESSONS),
  'p6-u244': () => import('./lessons/p6u244.js').then((m) => m.P6U244_LESSONS),
  'p6-u245': () => import('./lessons/p6u245.js').then((m) => m.P6U245_LESSONS),
  'p6-u246': () => import('./lessons/p6u246.js').then((m) => m.P6U246_LESSONS),
  'p6-u247': () => import('./lessons/p6u247.js').then((m) => m.P6U247_LESSONS),
  'p6-u248': () => import('./lessons/p6u248.js').then((m) => m.P6U248_LESSONS),
  'p6-u249': () => import('./lessons/p6u249.js').then((m) => m.P6U249_LESSONS),
  'p6-u250': () => import('./lessons/p6u250.js').then((m) => m.P6U250_LESSONS),
  'p6-u251': () => import('./lessons/p6u251.js').then((m) => m.P6U251_LESSONS),
  'p6-u252': () => import('./lessons/p6u252.js').then((m) => m.P6U252_LESSONS),
  'p6-u253': () => import('./lessons/p6u253.js').then((m) => m.P6U253_LESSONS),
  'p6-u254': () => import('./lessons/p6u254.js').then((m) => m.P6U254_LESSONS),
  'p6-u255': () => import('./lessons/p6u255.js').then((m) => m.P6U255_LESSONS),
  'p6-u256': () => import('./lessons/p6u256.js').then((m) => m.P6U256_LESSONS),
  'p6-u257': () => import('./lessons/p6u257.js').then((m) => m.P6U257_LESSONS),
  'p6-u214': () => import('./lessons/p6u214.js').then((m) => m.P6U214_LESSONS),
  'p6-u215': () => import('./lessons/p6u215.js').then((m) => m.P6U215_LESSONS),
  'p6-u216': () => import('./lessons/p6u216.js').then((m) => m.P6U216_LESSONS),
  'p6-u217': () => import('./lessons/p6u217.js').then((m) => m.P6U217_LESSONS),
  'p6-u218': () => import('./lessons/p6u218.js').then((m) => m.P6U218_LESSONS),
  'p6-u219': () => import('./lessons/p6u219.js').then((m) => m.P6U219_LESSONS),
  'p6-u220': () => import('./lessons/p6u220.js').then((m) => m.P6U220_LESSONS),
  'p6-u221': () => import('./lessons/p6u221.js').then((m) => m.P6U221_LESSONS),
  'p6-u222': () => import('./lessons/p6u222.js').then((m) => m.P6U222_LESSONS),
  'p6-u223': () => import('./lessons/p6u223.js').then((m) => m.P6U223_LESSONS),
  'p6-u224': () => import('./lessons/p6u224.js').then((m) => m.P6U224_LESSONS),
  'p6-u225': () => import('./lessons/p6u225.js').then((m) => m.P6U225_LESSONS),
  'p6-u226': () => import('./lessons/p6u226.js').then((m) => m.P6U226_LESSONS),
  'p6-u227': () => import('./lessons/p6u227.js').then((m) => m.P6U227_LESSONS),
  'p6-u228': () => import('./lessons/p6u228.js').then((m) => m.P6U228_LESSONS),
  'p6-u229': () => import('./lessons/p6u229.js').then((m) => m.P6U229_LESSONS),
  'p6-u230': () => import('./lessons/p6u230.js').then((m) => m.P6U230_LESSONS),
  'p6-u231': () => import('./lessons/p6u231.js').then((m) => m.P6U231_LESSONS),
  'p6-u232': () => import('./lessons/p6u232.js').then((m) => m.P6U232_LESSONS),
  'p6-u233': () => import('./lessons/p6u233.js').then((m) => m.P6U233_LESSONS),
  'p6-u234': () => import('./lessons/p6u234.js').then((m) => m.P6U234_LESSONS),
  'p6-u235': () => import('./lessons/p6u235.js').then((m) => m.P6U235_LESSONS),
  'p6-u236': () => import('./lessons/p6u236.js').then((m) => m.P6U236_LESSONS),
  'p6-u237': () => import('./lessons/p6u237.js').then((m) => m.P6U237_LESSONS),
  'p6-u238': () => import('./lessons/p6u238.js').then((m) => m.P6U238_LESSONS),
  'p6-u239': () => import('./lessons/p6u239.js').then((m) => m.P6U239_LESSONS),
  'p6-u240': () => import('./lessons/p6u240.js').then((m) => m.P6U240_LESSONS),
  'p6-u241': () => import('./lessons/p6u241.js').then((m) => m.P6U241_LESSONS),
  ...
  'p6-u210': () => import('./lessons/p6u210.js').then((m) => m.P6U210_LESSONS),
  'p6-u211': () => import('./lessons/p6u211.js').then((m) => m.P6U211_LESSONS),
  'p6-u212': () => import('./lessons/p6u212.js').then((m) => m.P6U212_LESSONS),
  'p6-u213': () => import('./lessons/p6u213.js').then((m) => m.P6U213_LESSONS),
  ...
  'p6-u282': () => import('./lessons/p6u282.js').then((m) => m.P6U282_LESSONS),
  'p6-u283': () => import('./lessons/p6u283.js').then((m) => m.P6U283_LESSONS),
  'p6-u284': () => import('./lessons/p6u284.js').then((m) => m.P6U284_LESSONS),
  'p6-u285': () => import('./lessons/p6u285.js').then((m) => m.P6U285_LESSONS),
  'p6-u286': () => import('./lessons/p6u286.js').then((m) => m.P6U286_LESSONS),
  'p6-u287': () => import('./lessons/p6u287.js').then((m) => m.P6U287_LESSONS),
  'p6-u288': () => import('./lessons/p6u288.js').then((m) => m.P6U288_LESSONS),
  'p6-u289': () => import('./lessons/p6u289.js').then((m) => m.P6U289_LESSONS),
