...
export const SINH10_C3_LESSONS: BiologyLesson[] = [
  {
    id: 'sinh10-c5-b13',
    animation: {
      title: 'ATP — đồng tiền năng lượng nạp và tiêu liên tục',
      description:
        'Một vòng tròn khép kín nối hai trạng thái ADP và ATP, chấm sáng chạy vòng quanh không ngừng. Nửa trên là ĐỒNG HOÁ và các phản ứng giải phóng năng lượng của dị hoá: khi phân giải chất hữu cơ, năng lượng được dùng để gắn thêm một nhóm phosphate vào ADP, tạo ATP — nạp tiền vào ví. Nửa dưới: ATP bị thuỷ phân, cắt liên kết cao năng giữa hai nhóm phosphate cuối, giải phóng khoảng 30,5 kJ mỗi mol để chạy các việc tốn năng lượng như tổng hợp chất, co cơ, vận chuyển chủ động, rồi trở lại thành ADP. Điều hình động phá được: ATP không phải kho dự trữ lâu dài mà là tiền lẻ tiêu ngay — một phân tử ATP quay vòng nhiều lần trong một ngày, nên tế bào phải tái tạo nó liên tục.',
      viewBoxWidth: 420,
      viewBoxHeight: 250,
      durationMs: 8000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 214,
          y: 64,
          text: 'Dị hoá giải phóng năng lượng → nạp ATP',
          size: 12,
          anchor: 'middle',
          fill: 'neutral',
        },
        {
          ...
          x: 214,
          y: 208,
          text: 'Thuỷ phân ATP ≈ 30,5 kJ/mol → co cơ, tổng hợp chất',
          size: 12,
          anchor: 'middle',
          fill: 'neutral',
        },
        {
          ...
          keyframes: [
            { atMs: 0, dx: 0, dy: 0 },
            { atMs: 1500, dx: 140, dy: 0 },
            { atMs: 2600, dx: 272, dy: 0 },
            { atMs: 3400, dx: 272, dy: 58 },
            { atMs: 4600, dx: 272, dy: 108 },
            { atMs: 6000, dx: 140, dy: 108 },
            { atMs: 7000, dx: 0, dy: 108 },
            { atMs: 8000, dx: 0, dy: 0 },
          ],
        },
      ],
      captions: [
        { atMs: 300, text: 'Bắt đầu từ ADP và nhóm phosphate tự do.' },
        {
          atMs: 2000,
          text: 'Phản ứng dị hoá giải phóng năng lượng, gắn thêm phosphate vào ADP để tạo ATP.',
        },
        { atMs: 4000, text: 'ATP là dạng năng lượng sẵn dùng của tế bào.' },
        {
          atMs: 5600,
          text: 'Thuỷ phân liên kết cao năng, giải phóng ≈ 30,5 kJ/mol cho co cơ, tổng hợp chất, vận chuyển chủ động.',
        },
        {
          atMs: 7200,
          text: 'Quay lại ADP: ATP là tiền lẻ tiêu ngay, quay vòng liên tục chứ không phải kho dự trữ.',
        },
      ],
    },
    grade: '10',
  ...
  },
  {
    id: 'sinh10-c6-b19',
    animation: {
      title: 'Nuôi cấy mô tế bào thực vật: từ mảnh lá đến cây con',
      description:
        'Sáu ô lần lượt kể lại quy trình nuôi cấy mô, mỗi ô là một bước không thể đảo thứ tự. Lấy mẫu mô còn non, thường là đỉnh sinh trưởng hoặc mảnh lá, vì tế bào ở đó còn khả năng phân chia mạnh. Khử trùng bề mặt mẫu bằng cồn và dung dịch hypochlorite để không một vi khuẩn hay bào tử nấm nào lọt vào môi trường giàu đường. Đặt mẫu lên môi trường dinh dưỡng có hormone: tỉ lệ auxin cao so với cytokinin thì mẫu phản phân hoá thành khối mô sẹo; đổi sang tỉ lệ cytokinin cao thì mô sẹo bật chồi; hạ cytokinin, tăng auxin thì chồi ra rễ thành cây hoàn chỉnh, đưa ra vườn ươm. Cái hình động cho thấy: chỉ cần đổi TỈ LỆ hai hormone là đổi hẳn cơ quan mọc ra, vì mọi tế bào đều mang đủ bộ gene của cây.',
      viewBoxWidth: 538,
      viewBoxHeight: 234,
      durationMs: 7800,
      loop: true,
      shapes: [
        {
          ...
          x: 269,
          y: 24,
          text: 'Quy trình nhân giống in vitro',
          size: 15,
          anchor: 'middle',
          fill: 'primary',
        },
      ...
      captions: [
        {
          atMs: 500,
          text: 'Lấy mô non còn khả năng phân chia mạnh, ví dụ đỉnh sinh trưởng hay mảnh lá.',
        },
        {
          atMs: 1600,
          text: 'Khử trùng bề mặt để nấm và vi khuẩn không lọt vào môi trường giàu đường.',
        },
        { atMs: 2700, text: 'Cấy lên môi trường dinh dưỡng vô trùng có hormone sinh trưởng.' },
        { atMs: 3800, text: 'Auxin cao so với cytokinin: tế bào phản phân hoá thành khối mô sẹo.' },
        { atMs: 4900, text: 'Tăng cytokinin thì bật chồi; sau đó tăng auxin thì chồi ra rễ.' },
        { atMs: 6000, text: 'Được hàng loạt cây con giống hệt cây mẹ, đưa ra vườn ươm.' },
      ],
    },
    grade: '10',
    chapterNumber: 6,
