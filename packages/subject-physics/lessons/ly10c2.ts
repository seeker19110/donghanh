...
export const LY10_C2_LESSONS: PhysicsLesson[] = [
  {
    id: 'ly10-c2-b4',
    animation: {
      title: 'Quãng đường đi theo đường thật, độ dịch chuyển đi tắt',
      description:
        'Một người xuất phát ở A, đi theo đường gấp khúc qua hai ngã rẽ rồi dừng ở B. Đường nét liền mà chấm tròn bò dọc theo chính là QUÃNG ĐƯỜNG s: nó cộng dồn từng đoạn thật sự đã đi, luôn dương và phụ thuộc vào lối đi. Mũi tên thẳng nối trực tiếp A tới B là ĐỘ DỊCH CHUYỂN d: một đại lượng vectơ, chỉ quan tâm điểm đầu và điểm cuối, có cả hướng. Vì thế d luôn ngắn hơn hoặc bằng s, chỉ bằng nhau khi đi thẳng một mạch không đổi chiều. Trường hợp đáng nhớ nhất: đi một vòng rồi về đúng chỗ cũ thì quãng đường rất lớn nhưng độ dịch chuyển bằng không.',
      viewBoxWidth: 440,
      viewBoxHeight: 220,
      durationMs: 4000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 120,
          y: 194,
          text: 's = 120 + 100 + 190 = 410 m (quãng đường)',
          size: 12,
          anchor: 'start',
          fill: 'muted',
        },
        ...
        },
        {
          ...
          x: 190,
          y: 120,
          text: 'd (độ dịch chuyển) — có hướng',
          size: 12,
          anchor: 'middle',
          fill: 'primary',
        },
        {
          ...
          x: 220,
          y: 30,
          text: 'luôn có d ≤ s, bằng nhau khi đi thẳng một mạch',
          size: 12,
          anchor: 'middle',
          fill: 'neutral',
        },
      ...
      captions: [
        {
          atMs: 0,
          text: 'Người đi theo đường gấp khúc từ A',
        },
        {
          atMs: 3800,
          text: 'Tới B: quãng đường dài, độ dịch chuyển chỉ là mũi tên A→B',
        },
      ],
    },
    grade: '10',
  ...
  },
  {
    id: 'ly10-c2-b7',
    animation: {
      title: 'Độ dốc của đồ thị d–t chính là vận tốc',
      description:
        'Hai xe cùng xuất phát từ gốc toạ độ, đồ thị độ dịch chuyển theo thời gian của chúng là hai đường thẳng có độ dốc khác nhau. Đường dốc hơn (màu chính) là xe nhanh: cùng một khoảng thời gian nó đi được xa hơn. Tam giác nét đứt dựng trên đồ thị cho thấy cách đọc vận tốc mà không cần công thức nào khác — lấy độ tăng theo trục đứng chia cho độ tăng theo trục ngang, v = Δd/Δt, đúng bằng độ dốc. Ba dạng đồ thị cần nhận ra ngay: đường thẳng dốc lên là chuyển động thẳng đều theo chiều dương, đường nằm ngang là vật đứng yên, còn đường dốc xuống là vật đi ngược chiều dương đã chọn.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4000,
      loop: true,
  ...
  },
  {
    id: 'ly10-c2-b8',
    animation: {
      title: 'Gia tốc là tốc độ ĐỔI của vận tốc, không phải vận tốc',
      description:
        'Hai hàng xe chạy song song, dưới mỗi xe là mũi tên vận tốc của nó tại từng thời điểm. Hàng trên: mũi tên luôn dài như nhau, vận tốc không đổi nên gia tốc bằng không, dù xe đang chạy rất nhanh. Hàng dưới: mỗi thời điểm mũi tên lại dài thêm một đoạn ĐÚNG BẰNG NHAU, nghĩa là vận tốc tăng đều — đó là chuyển động có gia tốc không đổi, a = Δv/Δt. Đây là chỗ dễ nhầm nhất của chương: nhanh hay chậm nói về vận tốc, còn gia tốc nói về việc vận tốc đang đổi nhanh tới đâu. Một vật có thể chạy rất nhanh mà gia tốc bằng không, hoặc đang đứng yên mà gia tốc khác không (lúc vừa bắt đầu rơi).',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4000,
      loop: false,
      shapes: [
        ...
        },
        {
          ...
          x: 230,
          y: 210,
          text: 'khoảng tăng của mũi tên luôn bằng nhau ⇒ a = Δv/Δt = hằng số',
          size: 12,
          anchor: 'middle',
          fill: 'muted',
        },
        {
          ...
          x: 230,
          y: 116,
          text: 'thời gian trôi đều từ trái sang phải',
          size: 11,
          anchor: 'middle',
          fill: 'muted',
        },
  ...
  },
  {
    id: 'ly10-c2-b9',
    animation: {
      title: 'Diện tích dưới đồ thị v–t là quãng đường đi được',
      description:
        'Đồ thị vận tốc theo thời gian của một xe chuyển động thẳng nhanh dần đều: một đường thẳng đi lên từ vận tốc đầu v₀, độ dốc của nó chính là gia tốc a, nên v = v₀ + a·t. Vùng tô màu bên dưới đường này lớn dần theo thời gian, và diện tích của nó chính bằng quãng đường xe đã đi. Vùng đó là một hình thang: cạnh đáy dưới là v₀, cạnh đáy trên là v, chiều cao là t. Tính diện tích hình thang ra đúng công thức quen thuộc s = v₀·t + a·t²/2 — một công thức người ta hay học vẹt, thật ra chỉ là công thức diện tích hình thang viết lại. Nếu xe chậm dần đều thì đường đi xuống, và phần dưới trục là quãng đường đi ngược chiều dương.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Xe bắt đầu với vận tốc v₀',
        },
        {
          atMs: 3800,
          text: 'Vùng tô màu lớn dần — đó là quãng đường đã đi',
        },
      ],
    },
    grade: '10',
