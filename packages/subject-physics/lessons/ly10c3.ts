      ...
      shapes: [
        ...
        },
        {
          ...
          keyframes: [
            { atMs: 0, scale: 0.5, dx: 0 },
            { atMs: 2500, scale: 2, dx: 0 },
            { atMs: 2700, scale: 1.6, dx: 0 },
            { atMs: 5000, scale: 1.6, dx: 200 },
          ],
        },
        {
          kind: 'label',
    ...
    animation: {
      ...
      shapes: [
        ...
        },
        {
          ...
          strokeWidth: 3,
          keyframes: [
            { atMs: 0, dy: 0, scale: 0.15 },
            { atMs: 1000, dy: 18, scale: 0.4 },
            { atMs: 2000, dy: 66, scale: 0.7 },
            { atMs: 3000, dy: 124, scale: 0.9 },
            { atMs: 4000, dy: 182, scale: 1 },
            { atMs: 5000, dy: 240, scale: 1 },
          ],
        },
        {
          kind: 'label',
        ...
        },
        {
          ...
          x: 14,
          y: 308,
          text: 'Hợp lực 0 nghĩa là vận tốc không đổi, không phải đứng yên',
          size: 11,
          anchor: 'start',
          fill: 'muted',
        },
      ...
      captions: [
        ...
        { atMs: 2000, text: 'Tốc độ tăng, lực cản dài dần ra và gia tốc nhỏ lại.' },
        { atMs: 4000, text: 'Lực cản bằng trọng lực: vật rơi đều ở tốc độ giới hạn.' },
      ],
    },
    grade: '10',
    chapterNumber: 3,
