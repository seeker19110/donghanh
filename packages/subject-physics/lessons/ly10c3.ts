...
export const LY10_C3_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    id: 'ly10-c3-b14',
    animation: {
      title: 'Không có lực cản thì vật cứ thế trượt mãi',
      description:
        'Hai chiếc hộp giống hệt nhau được đẩy cùng một cái rồi buông tay. Hộp trên trượt trên mặt NHÁM: mũi tên lực ma sát hướng ngược chiều chuyển động luôn có mặt, hộp chậm dần rồi dừng hẳn. Hộp dưới trượt trên mặt rất nhẵn coi như không ma sát: không còn lực nào theo phương ngang, hợp lực bằng không, nên nó giữ nguyên vận tốc và chạy hết hình mà không chậm đi chút nào. Đó chính là định luật 1 Newton: vật giữ nguyên trạng thái đứng yên hoặc chuyển động thẳng đều khi hợp lực tác dụng lên nó bằng không. Đời thường ta thấy vật luôn dừng lại, nên dễ tưởng "muốn chuyển động phải có lực đẩy" — thật ra cái làm nó dừng là ma sát, không phải bản tính của vật.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4500,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 90,
          y: 130,
          text: 'lực ma sát làm hộp chậm dần rồi dừng',
          size: 11,
          anchor: 'start',
          fill: 'muted',
        },
        ...
        },
        {
          ...
          x: 24,
          y: 182,
          text: 'mặt nhẵn lí tưởng (không ma sát)',
          size: 11,
          anchor: 'start',
          fill: 'muted',
        },
        ...
        },
        {
          ...
          x: 230,
          y: 28,
          text: 'Hợp lực = 0 ⇒ vận tốc KHÔNG đổi (định luật 1 Newton)',
          size: 13,
          anchor: 'middle',
          fill: 'primary',
        },
        {
          ...
          x: 230,
          y: 214,
          text: 'quán tính: vật chống lại mọi thay đổi vận tốc',
          size: 11,
          anchor: 'middle',
          fill: 'muted',
        },
  ...
  },
  {
    id: 'ly10-c3-b15',
    animation: {
      title: 'Cùng một lực, vật nặng gấp đôi thì gia tốc bằng nửa',
      description:
        'Hai xe được kéo bằng hai lực hoàn toàn như nhau — hai mũi tên dài bằng nhau. Xe trên có khối lượng m, xe dưới có khối lượng 2m (vẽ to gấp đôi). Sau cùng một khoảng thời gian, xe nhẹ đã đi xa gấp đôi xe nặng vì gia tốc của nó gấp đôi. Đó là nội dung định lượng của định luật 2 Newton: a = F/m, gia tốc tỉ lệ THUẬN với hợp lực và tỉ lệ NGHỊCH với khối lượng, và luôn cùng hướng với hợp lực. Khối lượng vì thế là số đo mức quán tính: cùng một lực tác dụng, vật nào khối lượng lớn hơn thì đổi vận tốc chậm hơn. Lưu ý F trong công thức là HỢP lực của mọi lực, không phải riêng lực ta đẩy.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4000,
      loop: false,
      shapes: [
        ...
        },
        {
          ...
          x: 230,
          y: 208,
          text: 'a = F / m — cùng F, m gấp đôi thì a còn một nửa',
          size: 13,
          anchor: 'middle',
          fill: 'primary',
        },
        {
          ...
          x: 230,
          y: 22,
          text: 'cùng một lực, cùng một khoảng thời gian',
          size: 12,
          anchor: 'middle',
          fill: 'muted',
        },
  ...
  },
  {
    id: 'ly10-c3-b18',
    animation: {
      title: 'Ma sát nghỉ lớn dần theo lực kéo, tới ngưỡng thì vật trượt',
      description:
        'Một thùng đứng yên trên sàn, ta kéo nó bằng lực F tăng dần (mũi tên đỏ dài ra). Lúc đầu thùng vẫn bất động vì lực ma sát NGHỈ tự động xuất hiện bằng đúng lực kéo và ngược chiều — hai mũi tên dài bằng nhau, hợp lực bằng không. Cột bên phải cho thấy độ lớn ma sát bám theo lực kéo cho tới một giá trị cực đại. Vượt qua ngưỡng đó, thùng bứt ra và bắt đầu trượt; từ lúc này lực cản đổi sang ma sát TRƯỢT, có độ lớn gần như không đổi F_mst = μ·N và thường nhỏ hơn ngưỡng nghỉ cực đại một chút — đó là lí do đẩy một chiếc tủ lúc đầu rất nặng tay, nhưng khi nó đã trượt thì đẩy nhẹ hơn hẳn.',
      viewBoxWidth: 460,
      viewBoxHeight: 240,
      durationMs: 5000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Kéo nhẹ: ma sát nghỉ cân bằng đúng lực kéo, thùng bất động',
        },
        {
          atMs: 3100,
          text: 'Vượt ngưỡng: thùng trượt, lực cản chuyển sang ma sát trượt',
        },
      ],
    },
    grade: '10',
  ...
  },
  {
    id: 'ly10-c3-b21',
    animation: {
      title: 'Đòn bẩy cân bằng khi hai moment quay ngược nhau bằng nhau',
      description:
        'Một thanh cứng tựa trên điểm tựa O ở giữa. Bên trái treo vật nặng 2F ở khoảng cách d, bên phải treo vật nhẹ F. Ban đầu phía trái nặng hơn nên thanh nghiêng xuống trái: moment M = F·d của bên trái lớn hơn bên phải. Kéo vật bên phải ra xa dần, cánh tay đòn của nó dài ra, moment bên phải tăng theo. Khi khoảng cách đúng bằng 2d thì F·2d = 2F·d, hai moment quay ngược chiều nhau bằng nhau, thanh trở lại nằm ngang và đứng yên. Đây là điều kiện cân bằng của vật rắn có trục quay: tổng moment làm quay theo chiều kim đồng hồ bằng tổng moment quay ngược lại. Cánh tay đòn phải đo theo khoảng cách VUÔNG GÓC từ trục quay tới giá của lực, không phải tới điểm đặt.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 4500,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 230,
          y: 30,
          text: 'M = F · d — cân bằng khi 2F·d = F·2d',
          size: 14,
          anchor: 'middle',
          fill: 'primary',
        },
      ...
      captions: [
        {
          atMs: 0,
          text: 'Bên trái nặng hơn: moment trái lớn hơn, thanh nghiêng',
        },
        {
          atMs: 3100,
          text: 'Đưa vật nhẹ ra xa gấp đôi: hai moment bằng nhau, thanh cân bằng',
        },
      ],
    },
    grade: '10',
