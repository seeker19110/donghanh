...
export const LY12_C3_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    ...
    animation: {
      ...
      description:
        'Bên trái là một nam châm vĩnh cửu, ba mũi tên xám cho thấy từ trường B của nó hướng sang phải, xuyên qua chỗ đặt cuộn dây. Cuộn dây (khối màu) gắn chặt vào màng loa hình nón. Khi dòng điện âm thanh chạy qua cuộn dây theo một chiều, lực từ F = B·I·L đẩy cuộn dây sang phải; nửa chu kì sau dòng đổi chiều, mũi tên lực lật lại chỉ sang trái và cuộn dây bị kéo về. Màng loa cứ thế đi tới đi lui đúng nhịp dòng điện, nén rồi giãn lớp không khí trước mặt thành sóng âm. Điều hình động cho thấy mà mô tả bằng lời khó nói: âm thanh không nằm sẵn trong nam châm hay trong dây, nó là bản sao cơ học của dòng điện — dòng điện dao động thế nào thì màng loa rung đúng như thế, nhanh thì tiếng cao, biên độ lớn thì tiếng to — cũng là nguyên lý biến dòng điện thành chuyển động của động cơ điện.',
      viewBoxWidth: 440,
      viewBoxHeight: 275,
      durationMs: 4800,
      loop: true,
      ...
      captions: [
        {
          atMs: 200,
          text: 'Dòng điện theo chiều thứ nhất: lực từ đẩy cuộn dây sang phải.',
        },
        {
          atMs: 1600,
