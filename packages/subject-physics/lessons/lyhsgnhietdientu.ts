...
export const LY_HSG_NHIET_DIEN_TU_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    ...
    animation: {
      ...
      description:
        'Hai ray nằm ngang nối với điện trở R ở đầu trái, đặt trong từ trường đều B hướng vào trong trang (dấu ⊗). Thanh dẫn trượt sang phải: diện tích mạch tăng nên từ thông biến thiên, sinh suất điện động e = B·l·v và dòng cảm ứng i = B·l·v/R chạy vòng kín qua điện trở — các mũi tên dòng điện hiện dần lên cùng lúc thanh chạy, vì khi v = 0 thì chưa có dòng nào. Dòng i trong từ trường chịu lực từ F_c = B²·l²·v/R, vẽ bằng mũi tên NGƯỢC chiều chuyển động đúng theo định luật Lenz: dòng cảm ứng chống lại nguyên nhân sinh ra nó. Mũi tên vận tốc và mũi tên lực cản cùng dài ra theo thời gian, còn mũi tên lực kéo F giữ nguyên độ dài; khi lực cản dài bằng lực kéo thì hợp lực và gia tốc bằng 0, thanh chạy đều với v_gh = F·R/(B²·l²).',
      viewBoxWidth: 460,
      viewBoxHeight: 240,
      durationMs: 6000,
      loop: true,
      shapes: [
        ...
        // Thanh dẫn: quãng đi mỗi giây tăng dần rồi ổn định — đúng dáng v(t) = v_gh(1 − e^(−t/τ)).
        {
          kind: 'line',
          id: 'thanh-dan',
          x1: 140,
        ...
        // Mũi tên vận tốc dài dần: v tăng từ 0 và tiến sát v_gh.
        {
          kind: 'arrow',
          id: 'mui-ten-v',
          x1: 140,
          ...
          keyframes: [
            ...
            { atMs: 1000, dx: 10, scale: 0.3 },
            { atMs: 2000, dx: 34, scale: 0.55 },
            { atMs: 3000, dx: 66, scale: 0.75 },
            { atMs: 4000, dx: 102, scale: 0.88 },
            { atMs: 5000, dx: 140, scale: 0.95 },
            { atMs: 6000, dx: 178, scale: 1 },
          ],
        },
        {
          kind: 'label',
        ...
        },
        {
          ...
          keyframes: [
            ...
            { atMs: 1000, dx: 10, opacity: 0.6 },
            { atMs: 2000, dx: 34, opacity: 1 },
            { atMs: 3000, dx: 66, opacity: 1 },
            { atMs: 4000, dx: 102, opacity: 1 },
            { atMs: 5000, dx: 140, opacity: 1 },
            { atMs: 6000, dx: 178, opacity: 1 },
          ],
        },
      ],
      captions: [
        ...
        {
          atMs: 2600,
          text: 'Dòng i nằm trong từ trường nên chịu lực từ F_c = B²·l²·v/R. Theo định luật Lenz, dòng cảm ứng chống lại nguyên nhân sinh ra nó — lực từ luôn NGƯỢC chiều vận tốc.',
        },
        {
          atMs: 4200,
          text: 'v càng lớn thì lực cản càng lớn, hợp lực F − F_c càng nhỏ: gia tốc giảm dần từ F/m chứ không phải hằng số. Không dùng được công thức chuyển động biến đổi đều.',
        },
        {
          atMs: 5400,
          text: 'Khi mũi tên lực cản dài bằng mũi tên lực kéo thì gia tốc bằng 0: thanh chạy đều với v_gh = F·R/(B²·l²), toàn bộ công của lực kéo biến thành nhiệt trên R.',
        },
      ],
    },
    track: 'advanced',
