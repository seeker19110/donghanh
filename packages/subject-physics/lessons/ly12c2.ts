...
export const LY12_C2_LESSONS: PhysicsLesson[] = [
  {
    id: 'ly12-c2-b8',
    animation: {
      title: 'Nén khí đẳng nhiệt: đường p–V là một nhánh hypebol',
      description:
        'Bên trái là xilanh chứa khí ở nhiệt độ giữ không đổi. Pit-tông đi xuống làm thể tích V giảm, các phân tử bị dồn lại nên số va chạm lên mỗi đơn vị diện tích thành bình tăng, tức áp suất p tăng. Bên phải, điểm trạng thái chạy dọc đường cong p·V = hằng số: V giảm một nửa thì p tăng gấp đôi — đó là định luật Boyle cho quá trình đẳng nhiệt. Định luật Charles là quá trình khác: giữ áp suất không đổi và đun nóng thì V tỉ lệ thuận với nhiệt độ tuyệt đối T, đồ thị p–V khi đó là một đoạn thẳng nằm ngang chứ không phải đường cong này.',
      viewBoxWidth: 460,
      viewBoxHeight: 220,
      durationMs: 4000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Thể tích lớn, áp suất nhỏ',
        },
        {
          atMs: 3600,
          text: 'Nén còn một nửa thể tích, áp suất tăng gấp đôi',
        },
      ],
    },
    grade: '12',
  ...
  },
  {
    id: 'ly12-c2-b9',
    animation: {
      title: 'Đi từ trạng thái 1 tới trạng thái 2 bằng hai chặng đã biết',
      description:
        'Phương trình trạng thái p₁V₁/T₁ = p₂V₂/T₂ nối hai trạng thái bất kì của cùng một khối khí, và hình này cho thấy vì sao nó đúng: ta luôn tách được đường đi thành hai chặng mà mỗi chặng là một định luật đã học. Chặng 1 (nét liền, màu chính): giữ nhiệt độ T₁ không đổi và nén theo đường hypebol Boyle từ điểm 1 tới điểm trung gian M. Chặng 2 (nét đứt): giữ thể tích V₂ không đổi và đun nóng từ T₁ lên T₂, điểm chạy thẳng đứng từ M lên điểm 2 theo định luật Gay-Lussac p/T = hằng số. Ghép hai chặng lại và khử đại lượng trung gian, ta được đúng phương trình trạng thái.',
      viewBoxWidth: 460,
      viewBoxHeight: 230,
      durationMs: 5000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Chặng 1: giữ T₁, nén theo đường Boyle tới M',
        },
        {
          atMs: 2600,
          text: 'Chặng 2: giữ V₂, đun từ T₁ lên T₂ tới trạng thái 2',
        },
      ],
    },
    grade: '12',
  ...
  },
  {
    id: 'ly12-c2-b10',
    animation: {
      title: 'Áp suất khí là tổng của vô số cú va đập phân tử',
      description:
        'Trong bình kín, các phân tử khí bay thẳng cho tới khi đập vào thành bình rồi bật ngược lại. Mỗi cú đập truyền cho thành một xung lượng rất nhỏ; vì mỗi giây có hàng tỉ tỉ cú đập trải đều nên ta chỉ cảm nhận được tác dụng trung bình, liên tục — đó chính là áp suất. Từ đây đọc ra hai hệ quả: nén bình cho nhỏ lại thì phân tử đập vào thành dày hơn nên áp suất tăng; đun nóng khí thì phân tử bay nhanh hơn, mỗi cú đập mạnh hơn và cũng dày hơn, áp suất cũng tăng. Nhiệt độ tuyệt đối T chính là thước đo động năng trung bình của chuyển động hỗn loạn này.',
      viewBoxWidth: 420,
      viewBoxHeight: 230,
      durationMs: 4000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 312,
          y: 118,
          text: 'mỗi cú đập = một xung lực lên thành',
          size: 11,
          anchor: 'start',
          fill: 'neutral',
        },
        {
          ...
          x: 155,
          y: 218,
          text: 'tổng vô số cú đập = ÁP SUẤT p',
          size: 13,
          anchor: 'middle',
          fill: 'primary',
        },
