...
export const LY12_C4_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    id: 'ly12-c4-b21',
    animation: {
      title: 'Năng lượng liên kết riêng và đỉnh bền vững ở vùng sắt',
      description:
        'Đồ thị biểu diễn năng lượng liên kết riêng (năng lượng liên kết chia cho số nuclôn, đơn vị MeV/nuclôn) theo số khối A. Đại lượng này chính là "độ bền" của hạt nhân: càng cao thì mỗi nuclôn càng bị giữ chặt. Đường cong đi lên rất nhanh ở vùng hạt nhân nhẹ, đạt cực đại khoảng 8,8 MeV/nuclôn quanh A ≈ 56 (vùng sắt, niken) rồi giảm chậm về phía các hạt nhân nặng như urani. Hình dạng đó giải thích cả hai cách lấy năng lượng hạt nhân: ghép hai hạt rất nhẹ lại (nhiệt hạch) hoặc bẻ một hạt rất nặng ra (phân hạch) đều đưa sản phẩm tới gần đỉnh hơn, và phần chênh lệch năng lượng liên kết được giải phóng.',
      viewBoxWidth: 460,
      viewBoxHeight: 240,
      durationMs: 5000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 250,
          y: 228,
          text: 'cả hai đều đi VỀ phía đỉnh nên toả năng lượng',
          size: 12,
          anchor: 'middle',
          fill: 'primary',
        },
      ...
      captions: [
        {
          atMs: 0,
          text: 'Hạt nhẹ: ghép lại để leo lên đỉnh (nhiệt hạch)',
        },
        {
          atMs: 2600,
          text: 'Hạt nặng: bẻ ra để leo lên đỉnh (phân hạch)',
        },
      ],
    },
    grade: '12',
  ...
  {
    id: 'ly12-c4-b23',
    // Đồ thị phân rã + đám hạt nhân tắt dần: cho thấy chu kì bán rã là "cứ mỗi T thì còn một nửa",
    // chứ không phải "sau 2T thì hết sạch".
    animation: {
      title: 'Chu kì bán rã: cứ sau mỗi T lại còn đúng một nửa',
      description:
        'Đường cong bên phải là số hạt nhân phóng xạ còn lại N theo thời gian t, với các mốc thời gian cách nhau đúng một chu kì bán rã T. Sau T đầu tiên số hạt nhân còn N₀/2; sau 2T còn N₀/4; sau 3T còn N₀/8; sau 4T còn N₀/16. Đường cong tụt rất nhanh lúc đầu rồi thoải dần, mãi tiến sát trục hoành mà không bao giờ chạm — nghĩa là mẫu chất KHÔNG bao giờ hết sạch sau một số chu kì hữu hạn, đây là điểm hay bị hiểu sai. Bên trái là đám 16 hạt nhân: sau mỗi chu kì lại có một nửa số hạt còn lại tắt đi, nhưng không thể đoán trước hạt NÀO sẽ tắt — phân rã là quá trình ngẫu nhiên với từng hạt nhân, chỉ có quy luật thống kê của cả đám mới chắc chắn. Công thức tương ứng: N = N₀·2^(−t/T) = N₀·e^(−λt), với hằng số phóng xạ λ = ln2 / T.',
      viewBoxWidth: 420,
      viewBoxHeight: 240,
      durationMs: 4000,
      loop: true,
      ...
      captions: [
        { atMs: 0, text: 'Ban đầu có N₀ hạt nhân phóng xạ.' },
        { atMs: 1100, text: 'Sau một chu kì bán rã T: còn đúng một nửa.' },
        { atMs: 2100, text: 'Sau 2T: còn N₀/4 — không phải hết sạch.' },
        { atMs: 4000, text: 'Đường cong mãi mãi tiến sát trục hoành mà không chạm tới.' },
      ],
    },
    grade: '12',
    chapterNumber: 4,
    ...
    checkQuestions: [
      ...
      },
      {
        ...
        prompt:
          'Một mẫu chất phóng xạ có chu kì bán rã T = 4 ngày. Sau 8 ngày, mẫu chất đó còn lại bao nhiêu phần so với ban đầu?',
        choices: [
          { id: 'het', label: 'Không còn gì, vì 8 ngày = 2 lần chu kì bán rã nên đã rã hết' },
          { id: 'mot_phan_tu', label: 'Còn 1/4 số hạt nhân ban đầu' },
          { id: 'mot_nua', label: 'Còn 1/2 số hạt nhân ban đầu' },
        ],
        answer: {
          kind: 'choice',
          correctIds: ['mot_phan_tu'],
        },
        explain:
          'Sau mỗi chu kì bán rã, một nửa số hạt nhân CÒN LẠI ở thời điểm đó bị phân rã — chứ không phải một nửa số ban đầu. ' +
          'Sau T thứ nhất còn N₀/2; T thứ hai lấy đi một nửa của N₀/2, nên còn N₀/4 = 25%. Công thức: N = N₀·2^(−t/T) = N₀·2^(−2) = N₀/4. ' +
          'Cách hiểu "hai lần chu kì bán rã là hết" là kiểu suy nghĩ tuyến tính, và nó dẫn tới kết luận nguy hiểm trong thực tế: chất thải phóng xạ có T hàng nghìn năm thì sau vài chu kì vẫn còn hoạt độ đáng kể. ' +
          'Về mặt toán học, hàm 2^(−t/T) luôn dương nên mẫu chất không bao giờ về đúng 0; chỉ khi số hạt nhân còn lại nhỏ tới mức đếm được thì bài toán mới hết ý nghĩa thống kê.',
      },
    ],
    srsCards: [
      {
  ...
  },
  {
    id: 'ly12-c4-b24',
    animation: {
      title: 'Phản ứng dây chuyền: một nơtron thành hai, thành bốn',
      description:
        'Một nơtron chậm (chấm nhỏ) đập vào hạt nhân urani-235. Hạt nhân bắt nơtron, trở nên mất ổn định và vỡ thành hai mảnh nhẹ hơn, đồng thời bắn ra trung bình 2–3 nơtron mới cùng một lượng năng lượng lớn. Mỗi nơtron mới lại có thể gây phân hạch một hạt nhân urani khác: số phản ứng nhân lên theo cấp số nhân qua từng thế hệ — đó là phản ứng dây chuyền. Đại lượng quyết định là hệ số nhân nơtron k: k < 1 phản ứng tắt dần, k = 1 phản ứng duy trì ổn định (chế độ của lò hạt nhân, giữ bằng thanh điều khiển hấp thụ bớt nơtron), k > 1 phản ứng bùng nổ. Nhiệt hạch thì ngược lại: ghép hai hạt nhân rất nhẹ, cần nhiệt độ hàng chục triệu độ.',
      viewBoxWidth: 460,
      viewBoxHeight: 240,
      durationMs: 4500,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Một nơtron bắn vào hạt nhân U-235',
        },
        {
          atMs: 1300,
          text: 'Hạt nhân vỡ, bắn ra 2–3 nơtron mới',
        },
        {
          atMs: 2700,
          text: 'Mỗi nơtron gây thêm một phân hạch: dây chuyền',
        },
      ],
    },
    grade: '12',
