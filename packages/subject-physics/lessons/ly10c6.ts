...
export const LY10_C6_LESSONS: PhysicsLesson[] = [
  {
    id: 'ly10-c6-b31',
    animation: {
      title: 'Tròn đều: tốc độ không đổi nhưng vận tốc thì đổi liên tục',
      description:
        'Một chất điểm chạy quanh đường tròn bán kính r với tốc độ không đổi. Bán kính nối tâm tới vật quét những góc bằng nhau trong những khoảng thời gian bằng nhau — đó là ý nghĩa của tốc độ góc ω = Δφ/Δt, đo bằng rad/s. Mũi tên vận tốc luôn nằm theo TIẾP TUYẾN của đường tròn, độ dài của nó không đổi (tốc độ dài v = ω·r không đổi) nhưng hướng thì xoay liên tục cùng vật. Vì vận tốc là đại lượng vectơ, hướng đổi cũng là vận tốc đổi, nên chuyển động tròn đều vẫn là chuyển động CÓ GIA TỐC — gia tốc đó hướng vào tâm và sẽ học ở bài lực hướng tâm. Một vòng hết chu kì T = 2π/ω, và tần số f = 1/T là số vòng mỗi giây.',
      viewBoxWidth: 420,
      viewBoxHeight: 240,
      durationMs: 4000,
      loop: true,
      shapes: [
        ...
        },
        {
          ...
          x: 210,
          y: 26,
          text: 'tốc độ không đổi, hướng vận tốc đổi liên tục',
          size: 12,
          anchor: 'middle',
          fill: 'muted',
        },
