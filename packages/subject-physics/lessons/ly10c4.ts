...
export const LY10_C4_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    id: 'ly10-c4-b26',
    animation: {
      title: 'Trượt máng: thế năng đổi thành động năng, tổng giữ nguyên',
      description:
        'Một xe nhỏ thả không vận tốc đầu từ đỉnh máng cong và trượt xuống, bỏ qua ma sát. Hai cột bên phải là hai kho năng lượng: cột xanh nhạt là thế năng trọng trường W_t = m·g·h, cột đậm là động năng W_đ = m·v²/2. Xe càng xuống thấp thì cột thế năng càng tụt, và đúng lượng tụt đó chuyển sang cột động năng đang dâng lên — ở chân máng thế năng gần như hết còn động năng lớn nhất, tức xe chạy nhanh nhất. Điều đáng nhìn nhất là TỔNG chiều cao hai cột không đổi suốt quá trình: đó là định luật bảo toàn cơ năng W = W_đ + W_t = hằng số, đúng khi vật chỉ chịu tác dụng của trọng lực. Có ma sát thì một phần cơ năng biến thành nhiệt và tổng sẽ tụt dần.',
      viewBoxWidth: 460,
      viewBoxHeight: 240,
      durationMs: 4000,
      loop: true,
      ...
      captions: [
        {
          atMs: 0,
          text: 'Ở đỉnh: toàn bộ là thế năng, xe chưa chuyển động',
        },
        {
          atMs: 3800,
          text: 'Ở chân máng: thế năng đã chuyển hết thành động năng',
        },
      ],
    },
    grade: '10',
