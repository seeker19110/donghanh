...
export const LY11_C3_LESSONS: PhysicsLesson[] = [
  ...
  },
  {
    ...
    animation: {
      ...
      loop: true,
      shapes: [
        { kind: 'rect', id: 'ban-duong', x: 40, y: 44, w: 260, h: 10, rx: 2, fill: 'primary' },
        { kind: 'rect', id: 'ban-am', x: 40, y: 196, w: 260, h: 10, rx: 2, fill: 'accent' },
        {
          kind: 'arrow',
          id: 'suc-0',
          x1: 70,
    ...
    animation: {
      ...
      shapes: [
        ...
        },
        {
          ...
          x: 12,
          y: 242,
          text: 'Đường sức luôn vuông góc mặt đẳng thế và hướng về điện thế thấp',
          size: 11,
          anchor: 'start',
          fill: 'muted',
        },
