// lessonsLoader.ts — tra cứu bài học môn Vật lí cho GIAO DIỆN, không kéo cả môn vào bundle.
//
...
export const PHYSICS_LOADER = createStemLessonLoader<PhysicsLesson>(LESSON_INDEX, CHAPTER_LOADERS)
